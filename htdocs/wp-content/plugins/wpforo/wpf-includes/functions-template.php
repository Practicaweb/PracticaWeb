        ...
        if( $thread['usergroup_can_va'] && $thread['feature_avatars'] ) {
            ...
            if( $thread['replies'] && !empty( $thread['last_user'] ) ) {
                ...
                $thread['users_html'] .= '<div class="wpf-circle wpf-s">
                        <a href="' . esc_url( $thread['last_user']['profile_url'] ) . '" wpf-tooltip="' . $thread['reply_user_info'] . '" wpf-tooltip-position="top" wpf-tooltip-size="medium">' . $thread['last_user_avatar'] . '</a>
                    </div>';
            }
        } else {
